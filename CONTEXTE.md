...
* Un seul supabase-client.js partagé (pas encore créé — clés inline pour l'instant)
...
* **Vercel** : connecté au repo GitHub, déploiement automatique sur push main
...
* Toujours donner le code directement dans le chat, jamais de fichier à télécharger

## 6. ÉTAT ACTUEL DU PROJET

### Fichiers en production
* **deals.html** ✅ — Kanban drag & drop, toggle liste/kanban, Supabase connecté, toast, rollback
...
* RLS désactivé ✅
* Données : vides (1 deal de test)
* Données Pipedrive : CSV en attente d'import
...
## 8. DESIGN SYSTEM (deals.html = référence)

* Fond : #eeece8 / Surface : #ffffff
* Typo : DM Sans + DM Mono (Google Fonts)
* Topbar sticky blanche, logo ERC, chip compteur, toggle vue
* Cards blanches, border #e2ddd8, ombre légère
* Badges étapes pastels avec point coloré
* Couleurs : qualification #3b82f6, diagnostic #8b5cf6, valorisation #ec4899, recherche #f97316, negociation #eab308, closing #22c55e, perdu #ef4444
...
* Pas d'architecture multi-fichiers JS
